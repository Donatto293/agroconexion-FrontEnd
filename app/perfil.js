...
  // No es necesario cargar datos de otras secciones si no se van a mostrar
...
  // Si no hay usuario, mostrar la pantalla de inicio de sesión
  if (!user) {
    return (
...
  // No es necesario el estado de carga si no se hace ninguna petición
  // if (loading) {
  //   return (
...
      />
      <Text style={styles.favoriteName} numberOfLines={1}>{item.product.name}</Text>
  ...
  <ScrollView contentContainerStyle={styles.container}>
    ...
    <View style={styles.profileHeader}>
      <View style={styles.avatarContainer}>
        <Image
          source={{ uri: `${API_URL}${user.profile_image}` || 'https://i.imgur.com/8Km9tLL.png' }}
          style={styles.avatar}
        />
        <TouchableOpacity
          style={styles.editAvatarButton}
          onPress={() => router.push('configPerfil/editPerfil')}
        >
